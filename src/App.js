...
function App() {
  const initialFavoritesNews = useLocalStorage("displayFavoritesNews", initialState);

  // Initializam reducerul pentru produse favorite.
  const [favoritesState, favoritesDispatch] = useReducer(favoritesReducer, initialFavoritesNews[0]);
